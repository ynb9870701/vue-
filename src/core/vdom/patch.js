...
export function createPatchFunction (backend) {
  ...
  function createChildren (vnode, children, insertedVnodeQueue) {
    if (Array.isArray(children)) {
      ...
      // 遍历子虚拟节点 递归的调用 createElm 方法 (深度优先的遍历算法)
      // 遍历过程中将 vnode.elm 作为父容器的 DOM 节点占位符传入
   ...
   * 最终返回了一个 patch 方法这个方法就赋值给了 vm._update 函数里调用的 vm.__patch__
   * 
   */
